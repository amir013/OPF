...
G_matrix = pd.DataFrame([
    [1.07, 0.00, -1.07, 0.00, 0.0],
    [0.00, 5.66, 0.00, -5.66, 0.0],
    [-1.07, 0.00, 1.41, -0.09, 0.0],
    [0.00, -5.66, -0.49, 5.95, 0.0],
    [0.00, 0.00, 0.00, 0.00, 0.0]
])

# Imaginary Admittance Matrix (B matrix - 5x5)
B_matrix = pd.DataFrame([
    [-2.14, 0.00, 2.14, 0.00, 0.0],
    [0.00, -10.11, 0.00, 10.11, 0.0],
    [2.14, 0.00, -2.83, 0.18, 0.0],
    [0.00, 10.11, 0.18, -11.90, 0.0],
    [0.00, 0.00, 0.00, 0.00, 0.0]
])
